...
namespace Gestao_de_Projetos.Controllers
{
    public class Estado_ProjetoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstado,Projeto_Estado")] Estado_Projeto estado_Projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstado,Projeto_Estado")] Estado_Projeto estado_Projeto)
        {
            if (id != estado_Projeto.IdEstado)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!Estado_ProjetoExists(estado_Projeto.IdEstado))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Estado_Projeto.Any(e => e.IdEstado == id);
        }
    }
}
